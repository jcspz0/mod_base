...
@section('panel-title', session('parametros')[16]['VALOR'])
...
{!!Form::open(['route' => 'rol.store', 'method' => 'POST', 'class' => 'form-group-sm form-horizontal'])!!}	
	<div class="col-xs-10 col-xs-push-1 col-sm-8 col-sm-push-2">
		...
		<div class="form-group" align="center">
			<button type="submit" class="btn btn-primary">{{session('parametros')[17]['VALOR']}}</button>
			<a href="{{ route('rol.index') }}" class="btn btn-danger">{{session('parametros')[18]['VALOR']}}</a>
		</div>				
